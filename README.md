...
running command...
$ pre-core (--version)
@oclif/plugin-test-pre-core/0.4.19 linux-x64 node-v20.20.2
...
_See code: [src/commands/pre-core.ts](https://github.com/oclif/plugin-test-pre-core/blob/0.4.19/src/commands/pre-core.ts)_
<!-- commandsstop -->
