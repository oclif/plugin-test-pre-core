...
running command...
$ pre-core (--version)
@oclif/plugin-test-pre-core/0.4.20 linux-x64 node-v22.22.3
...
_See code: [src/commands/pre-core.ts](https://github.com/oclif/plugin-test-pre-core/blob/0.4.20/src/commands/pre-core.ts)_
<!-- commandsstop -->
